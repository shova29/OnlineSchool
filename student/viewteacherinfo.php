...
<body style="background-image: url(images/teacherinfo.jpg);
            background-size: cover;
            background-repeat: no-repeat;
           font-family: sans-serif;
           ">
          
           <div class="col-5" style="margin-top: 70px; left: 50px;margin-left: 100px;">
            <div>
             <h1 style="color:#20B2AA;text-align: center;">
             ...
             <table class="table table-bordered" style="margin-top: 60px;left:30px">
                ...
                $sql = " select name,birthdate,gender,email,password,phonenumber,usertype from tbteachersignup";  
