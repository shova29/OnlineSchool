...
if(isset($_POST['submit'])){
    ...
    $sql = "insert into tbstudentsignup(name,birthdate,gender,email,password,phonenumber,usertype) values ('$name','$birthdate','$gender','$email','$password','$phonenumber,$usertype')";
    if ($conn->query($sql)){
 ...
 <div class="form">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
	 ...
	 <p class="message">Already have an account?<a href="../student/signin.php"> Signin</a>
	 </p>
	 </form>
 </div>
 </div>
